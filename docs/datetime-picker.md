...
The inner Date and Time labels are hidden by default. Add `show-part-labels` to display them. Use `variant="joined"` to attach both controls into one visual field.
