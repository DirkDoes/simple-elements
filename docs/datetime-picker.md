...
<se-datetime-picker label="Publish at" name="post[published_at]" value="2026-09-06T14:30" time-variant="spinner"></se-datetime-picker>
```
...
Set `time-variant="spinner"` to use the typed and scrollable time picker inside the datetime component.
