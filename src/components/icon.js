...
class SeIcon extends HTMLElement {
  ...
  render() {
    const body = icons[this.getAttribute('name')] || icons.alert;
    this.innerHTML = `<svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${body}</svg>`;
  }
}
