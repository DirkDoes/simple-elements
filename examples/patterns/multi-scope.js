...
export const multiScopePattern = {
  ...
  examples: [
    ['Contextual sidebar', 'One sidebar changes with the current scope. Open a workspace from the cards, then use Back to workspaces to choose another.', 'sidebar'],
    ...
    ['Top navigation', 'Route tabs and workspace cards suit apps with fewer pages and no persistent sidebar.', 'top'],
