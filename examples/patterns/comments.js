function commentDemo() {
  const root = document.querySelector('#comment-demo');
...
export const commentsPattern = { tag: 'comments', icon: 'messages-square', isolated: true, description: 'Comment discussions with nested replies and emoji reactions. Replies and resolution are local demo state.', examples: [
 { title: 'Blog discussion', description: 'A Markdown article with a working comment form, threaded replies, and reactions.', markup: `${styles}<div id="comment-demo"><article class="blog-article"><se-badge text="FIELD NOTES" tone="brand"></se-badge><div class="blog-meta"><se-profile name="Alex Morgan" initials="AM" subtitle="September 15 · 3 min read" tone="gray"></se-profile></div><se-markdown source="${`# A little less noise, a lot more focus
