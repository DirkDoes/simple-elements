...
const iconNames = {
  ...
  file: 'FileText', folder: 'Folder', italic: 'Italic', link: 'Link', lock: 'Lock', list: 'List', 'list-header': 'PanelTop', 'list-ordered': 'ListOrdered', 'list-row': 'Rows3', 'list-start': 'ListStart', mail: 'Mail', menu: 'Menu', 'message-help': 'MessageCircleQuestion', 'message-square': 'MessageSquare',
