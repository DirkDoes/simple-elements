...
import { calendarDays, dateValue, parseDate } from '../src/calendar.js';
...
for (const component of ['datetime-picker', 'time-picker']) assert.match(await readFile(`src/components/${component}.js`, 'utf8'), /defineNativeInput/);
